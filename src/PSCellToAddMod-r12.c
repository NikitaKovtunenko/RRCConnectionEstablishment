...
asn_TYPE_member_t asn_MBR_PSCellToAddMod_r12_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct PSCellToAddMod_r12, cellIdentification_r12),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct PSCellToAddMod_r12, radioResourceConfigCommonPSCell_r12),
	...
	{ ATF_POINTER, 1, offsetof(struct PSCellToAddMod_r12, radioResourceConfigDedicatedPSCell_r12),
...
static const int asn_MAP_PSCellToAddMod_r12_oms_1[] = { 1, 2, 3 };
