...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType18_r12_1[] = {
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType18_r12, commConfig_r12),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType18_r12, lateNonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_SystemInformationBlockType18_r12_oms_1[] = { 0, 1 };
