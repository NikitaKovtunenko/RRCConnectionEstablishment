...
asn_TYPE_member_t asn_MBR_FailureReportSCG_r12_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct FailureReportSCG_r12, measResultServFreqList_r12),
	...
	{ ATF_POINTER, 1, offsetof(struct FailureReportSCG_r12, measResultNeighCells_r12),
...
static const int asn_MAP_FailureReportSCG_r12_oms_1[] = { 1, 2 };
