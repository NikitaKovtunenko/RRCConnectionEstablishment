...
asn_TYPE_member_t asn_MBR_LogMeasInfo_r10_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct LogMeasInfo_r10, measResultNeighCells_r10),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct LogMeasInfo_r10, measResultListEUTRA_v1090),
	...
	{ ATF_POINTER, 4, offsetof(struct LogMeasInfo_r10, measResultListMBSFN_r12),
	...
	{ ATF_POINTER, 3, offsetof(struct LogMeasInfo_r10, measResultServCell_v1250),
	...
	{ ATF_POINTER, 2, offsetof(struct LogMeasInfo_r10, servCellRSRQ_Type_r12),
	...
	{ ATF_POINTER, 1, offsetof(struct LogMeasInfo_r10, measResultListEUTRA_v1250),
...
static const int asn_MAP_LogMeasInfo_r10_oms_1[] = { 0, 4, 5, 6, 7, 8, 9 };
