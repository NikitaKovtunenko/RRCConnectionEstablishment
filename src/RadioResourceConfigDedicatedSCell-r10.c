...
asn_TYPE_member_t asn_MBR_RadioResourceConfigDedicatedSCell_r10_1[] = {
	{ ATF_POINTER, 3, offsetof(struct RadioResourceConfigDedicatedSCell_r10, physicalConfigDedicatedSCell_r10),
	...
	{ ATF_POINTER, 2, offsetof(struct RadioResourceConfigDedicatedSCell_r10, mac_MainConfigSCell_r11),
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicatedSCell_r10, naics_Info_r12),
...
static const int asn_MAP_RadioResourceConfigDedicatedSCell_r10_oms_1[] = { 0, 1, 2 };
