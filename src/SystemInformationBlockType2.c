...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType2_1[] = {
	...
	{ ATF_POINTER, 8, offsetof(struct SystemInformationBlockType2, lateNonCriticalExtension),
	...
	{ ATF_POINTER, 7, offsetof(struct SystemInformationBlockType2, ssac_BarringForMMTEL_Voice_r9),
	...
	{ ATF_POINTER, 6, offsetof(struct SystemInformationBlockType2, ssac_BarringForMMTEL_Video_r9),
	...
	{ ATF_POINTER, 5, offsetof(struct SystemInformationBlockType2, ac_BarringForCSFB_r10),
	...
	{ ATF_POINTER, 4, offsetof(struct SystemInformationBlockType2, ac_BarringSkipForMMTELVoice_r12),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct SystemInformationBlockType2, ac_BarringSkipForMMTELVideo_r12),
		(ASN_TAG_CLASS_CONTEXT | (11 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType2, ac_BarringSkipForSMS_r12),
		(ASN_TAG_CLASS_CONTEXT | (12 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType2, ac_BarringPerPLMN_List_r12),
...
static const int asn_MAP_SystemInformationBlockType2_oms_1[] = { 0, 4, 6, 7, 8, 9, 10, 11, 12, 13 };
