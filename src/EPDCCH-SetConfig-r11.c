...
asn_TYPE_member_t asn_MBR_EPDCCH_SetConfig_r11_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct EPDCCH_SetConfig_r11, re_MappingQCL_ConfigId_r11),
	...
	{ ATF_POINTER, 1, offsetof(struct EPDCCH_SetConfig_r11, csi_RS_ConfigZPId2_r12),
...
static const int asn_MAP_EPDCCH_SetConfig_r11_oms_1[] = { 5, 6 };
