...
asn_TYPE_member_t asn_MBR_MeasResultServFreq_r10_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct MeasResultServFreq_r10, measResultSCell_v1250),
	...
	{ ATF_POINTER, 1, offsetof(struct MeasResultServFreq_r10, measResultBestNeighCell_v1250),
