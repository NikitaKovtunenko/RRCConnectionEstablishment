...
asn_TYPE_member_t asn_MBR_SL_SyncConfig_r12_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct SL_SyncConfig_r12, txParameters_r12),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SL_SyncConfig_r12, rxParamsNCell_r12),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
...
static const int asn_MAP_SL_SyncConfig_r12_oms_1[] = { 3, 4 };
