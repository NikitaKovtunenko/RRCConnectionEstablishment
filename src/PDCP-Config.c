...
asn_TYPE_member_t asn_MBR_PDCP_Config_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct PDCP_Config, rn_IntegrityProtection_r10),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct PDCP_Config, pdcp_SN_Size_v1130),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct PDCP_Config, ul_DataSplitDRB_ViaSCG_r12),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BOOLEAN,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct PDCP_Config, t_Reordering_r12),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_PDCP_Config_oms_1[] = { 0, 1, 2, 4, 5, 6, 7 };
