...
static int
memb_thresholdBeaconRSSI_Low_r12_constraint_25(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_thresholdBeaconRSSI_High_r12_constraint_25(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_thresholdBeaconRSSI_Low_r12_constr_26 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 8,  8,  0,  255 }	/* (0..255) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_thresholdBeaconRSSI_High_r12_constr_27 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 8,  8,  0,  255 }	/* (0..255) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_thresholdBeaconRSSI_r12_25[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct WLAN_OffloadConfig_r12__thresholdBeaconRSSI_r12, thresholdBeaconRSSI_Low_r12),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_thresholdBeaconRSSI_Low_r12_constr_26,  memb_thresholdBeaconRSSI_Low_r12_constraint_25 },
		0, 0, /* No default value */
		"thresholdBeaconRSSI-Low-r12"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct WLAN_OffloadConfig_r12__thresholdBeaconRSSI_r12, thresholdBeaconRSSI_High_r12),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_thresholdBeaconRSSI_High_r12_constr_27,  memb_thresholdBeaconRSSI_High_r12_constraint_25 },
		0, 0, /* No default value */
		"thresholdBeaconRSSI-High-r12"
		},
};
static const ber_tlv_tag_t asn_DEF_thresholdBeaconRSSI_r12_tags_25[] = {
	(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_thresholdBeaconRSSI_r12_tag2el_25[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* thresholdBeaconRSSI-Low-r12 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* thresholdBeaconRSSI-High-r12 */
};
static asn_SEQUENCE_specifics_t asn_SPC_thresholdBeaconRSSI_r12_specs_25 = {
	sizeof(struct WLAN_OffloadConfig_r12__thresholdBeaconRSSI_r12),
	offsetof(struct WLAN_OffloadConfig_r12__thresholdBeaconRSSI_r12, _asn_ctx),
	asn_MAP_thresholdBeaconRSSI_r12_tag2el_25,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_thresholdBeaconRSSI_r12_25 = {
	"thresholdBeaconRSSI-r12",
	"thresholdBeaconRSSI-r12",
	&asn_OP_SEQUENCE,
	asn_DEF_thresholdBeaconRSSI_r12_tags_25,
	sizeof(asn_DEF_thresholdBeaconRSSI_r12_tags_25)
		/sizeof(asn_DEF_thresholdBeaconRSSI_r12_tags_25[0]) - 1, /* 1 */
	asn_DEF_thresholdBeaconRSSI_r12_tags_25,	/* Same as above */
	sizeof(asn_DEF_thresholdBeaconRSSI_r12_tags_25)
		/sizeof(asn_DEF_thresholdBeaconRSSI_r12_tags_25[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_thresholdBeaconRSSI_r12_25,
	2,	/* Elements count */
	&asn_SPC_thresholdBeaconRSSI_r12_specs_25	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_WLAN_OffloadConfig_r12_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct WLAN_OffloadConfig_r12, thresholdBeaconRSSI_r12),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_thresholdBeaconRSSI_r12_25,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"thresholdBeaconRSSI-r12"
...
static const asn_TYPE_tag2member_t asn_MAP_WLAN_OffloadConfig_r12_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* thresholdBeaconRSSI-r12 */
