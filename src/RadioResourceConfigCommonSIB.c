...
asn_TYPE_member_t asn_MBR_RadioResourceConfigCommonSIB_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct RadioResourceConfigCommonSIB, uplinkPowerControlCommon_v1020),
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigCommonSIB, rach_ConfigCommon_v1250),
...
static const int asn_MAP_RadioResourceConfigCommonSIB_oms_1[] = { 10, 11 };
