...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_19 = {
	sizeof(struct RRCConnectionReconfiguration_v1250_IEs__nonCriticalExtension),
	offsetof(struct RRCConnectionReconfiguration_v1250_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
