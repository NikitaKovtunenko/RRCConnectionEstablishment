...
asn_TYPE_member_t asn_MBR_IdleModeMobilityControlInfo_1[] = {
	{ ATF_POINTER, 8, offsetof(struct IdleModeMobilityControlInfo, freqPriorityListEUTRA),
	...
	{ ATF_POINTER, 7, offsetof(struct IdleModeMobilityControlInfo, freqPriorityListGERAN),
	...
	{ ATF_POINTER, 6, offsetof(struct IdleModeMobilityControlInfo, freqPriorityListUTRA_FDD),
	...
	{ ATF_POINTER, 5, offsetof(struct IdleModeMobilityControlInfo, freqPriorityListUTRA_TDD),
	...
	{ ATF_POINTER, 4, offsetof(struct IdleModeMobilityControlInfo, bandClassPriorityListHRPD),
	...
	{ ATF_POINTER, 3, offsetof(struct IdleModeMobilityControlInfo, bandClassPriorityList1XRTT),
	...
	{ ATF_POINTER, 2, offsetof(struct IdleModeMobilityControlInfo, t320),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_t320_8,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct IdleModeMobilityControlInfo, freqPriorityListExtEUTRA_r12),
...
static const int asn_MAP_IdleModeMobilityControlInfo_oms_1[] = { 0, 1, 2, 3, 4, 5, 6, 7 };
